...
class Scene2 extends Phaser.Scene{
    ...
    create(){
        //modifying image -> tileSprite in order for background to scroll
        ...
        //variable to listen for keyboard events
    ...
    //function to control player movement using keyboard
    movePlayerManager(){
    ...
    //function to move the ship on the y-axis
    moveShip(ship, speed){
        ship.y += speed;
